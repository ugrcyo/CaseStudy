        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 1, 4, 0, 23, 0, 611, DateTimeKind.Local).AddTicks(9010)),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockInfos_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockInfos_Variants_VariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockInfos_ProductId",
                table: "StockInfos",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_StockInfos_VariantId",
                table: "StockInfos",
                column: "VariantId");
